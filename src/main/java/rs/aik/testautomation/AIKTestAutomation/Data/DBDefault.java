...
/**
 * Class for communication with default DB
 */
public class DBDefault {
    //region - static connection to database
    private static String dbEngine = DataManager.dbEngine;
    private static String dbConnectionString = DataManager.dbConnectionString;
    private static String dbUser = DataManager.dbUser;
    private static String dbPassword = DataManager.dbPassword;
