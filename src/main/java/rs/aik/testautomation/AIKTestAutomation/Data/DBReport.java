...
public class DBReport {
    ...
    //private static String dbEngine = DataManager.getDataFromConfiguration("1","dbEngineReport");
    //private static String dbConnectionString = DataManager.getDataFromConfiguration("1","dbConnectionStringReport");
